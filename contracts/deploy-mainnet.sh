...
## -------- Data Seed --------
## Add DAOs
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Marketing DAO", "handle":"marketing-dao", "description":"Marketing DAO is one of the longest standing community funding verticals of the NEAR ecosystem. Founded in 2021, the original vision for the Marketing DAO was to fund Passion Projects.","logo_url":"https://ipfs.near.social/ipfs/bafkreigx7nkumnrr5wx22ykgwb26zyo76miu3d2ogsl7y5wbamx2sxi3lm", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":["marketing", "ndc", "nft"], "metrics":[], "metadata":{"website":"https://near.org/ndcdev.near/widget/MDAO.App?page=home"}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Gaming DAO", "handle":"gaming-dao", "description":"Сommunity of gamers and game creators based on NEAR Protocol.","logo_url":"https://pbs.twimg.com/profile_images/1662444707144781828/V2OZ7XBo_400x400.jpg", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":["gaming", "nft"], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"She is Near", "handle":"she-is-near-dao", "description":"She is Near description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":[], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Near Research Collective", "handle":"near-research-collective", "description":"Near Research Collective description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":["research"], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Onboarding DAO", "handle":"onboarding-dao", "description":"Onboarding DAO description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":[], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Build DAO", "handle":"build-dao", "description":"Build DAO description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":[], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Aurora DAO", "handle":"aurora-dao", "description":"Aurora DAO description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":["aurora"], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Degens DAO", "handle":"degens-dao", "description":"Degens DAO description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":[], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"Globe DAO", "handle":"globe-dao", "description":"Globe DAO description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":[], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
# NEAR_ENV=mainnet near call "$CONTRACT" add_dao '{"body": {"title":"NFT DAO", "handle":"nft-dao", "description":"NFT DAO description","logo_url":"", "banner_url":"","is_congress":false}, "owners":["'$ACCOUNT_ID'"], "verticals":["nft"], "metrics":[], "metadata":{}}' --accountId "$CONTRACT"
#
#
## Add DAO Proposal
...
# NEAR_ENV=mainnet near call "$CONTRACT" add_comment '{"post_id":1, "reply_to":5, "description":"Level 3 comment. Agree, comment with 2 attachments!", "attachments":["https://near.org/_next/static/media/near-logo.1416a213.svg", "https://nearweek.com/uploads/embed,f_webp,w_320/placeholder_medium_1_b968e77065.jpg"]}' --accountId "$ACCOUNT_ID"
