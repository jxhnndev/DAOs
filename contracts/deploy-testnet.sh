...
# Add DAO Proposal
 near call "$CONTRACT" add_dao_post '{"dao_id":1, "body":{"title":"Proposal title #1", "description":"Proposal description 1...", "attachments":[], "labels":[], "metrics":{}, "reports":[], "post_type": "Proposal", "proposal_version": "V1"}}' --accountId "$ACCOUNT_ID"
 near call "$CONTRACT" add_dao_post '{"dao_id":1, "body":{"title":"Report title #2", "description":"Report description 2...", "attachments":["https://some_attachment.com", "https://some2_attachment.com"], "labels":["report-label", "gaming"], "metrics":{}, "proposal_id":1, "post_type": "Report", "report_version": "V1"}}' --accountId "$ACCOUNT_ID"
 near call "$CONTRACT" add_dao_post '{"dao_id":2, "body":{"title":"Proposal title #3", "description":"Proposal description 3...", "attachments":[], "labels":[], "metrics":{}, "reports":[], "post_type": "Proposal", "proposal_version": "V1"}}' --accountId "$ACCOUNT_ID"
